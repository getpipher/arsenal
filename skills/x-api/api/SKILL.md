...
### OAuth 1.0a (User Context — @RZMetaversity)
```bash
...
### OAuth 2.0 (User Context — @RZMetaversity)
```bash
...
### Write Operations (OAuth 1.0a — @RZMetaversity)
...
**Require RECTOR's approval first:**
