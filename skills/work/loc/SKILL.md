...
- **Repo names:** Space-separated list of repo names (looks in ~/local-dev/)
...
**For organization-wide (example with getlumos):**
```bash
REPOS="lumos vscode-lumos awesome-lumos docs-lumos lumos-action intellij-lumos tree-sitter-lumos nvim-lumos lumos-mode sublime-lumos lumos-website"
...
|------------|-------|-------|------|----------|--------|
| lumos      | 103   | 49888 | 25633| 15340    | 8915   |
...
- `getlumos` - Count all getlumos organization repos
