...
/git:solve sip-app#55,101      # Cross-repo issues (sip-app#55 + current#101)
...
/git:solve --org
# Lists available issues from sip-protocol, sip-website, sip-app, etc.

# Work on issues from multiple repos
/git:solve sip-app#55,sip-website#30,101
# Works on:
#   - sip-app issue #55
#   - sip-website issue #30
#   - sip-protocol (current repo) issue #101
