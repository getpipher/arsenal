...
audited: 2026-04-05
patches: removed Orb explorer mandate, softened MCP dependency to optional
---
...
If Helius MCP tools are available, prefer them for RPC calls. Otherwise, fall back to standard RPC endpoints or the user's configured provider.
...
### Links & Explorers
- Use the user's preferred Solana explorer for transaction and account links. Common options: Solscan, Solana FM, XRAY, Orb, or SolanaFM.
