...
Before setting up deployment, ask RECTOR which style:
...
- `docker/metadata-action@v5` auto-lowercases image tags — use it when org names have uppercase (e.g. RECTOR-LABS).
