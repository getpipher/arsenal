...
1. **Extract Mission & Purpose**
   - Read CLAUDE.md (primary source) for Repository Overview and Tech Stack
   - Fallback to README.md if CLAUDE.md doesn't exist
...
- If not found, check README.md:
  ...
  - Tech Stack section
- If no docs found: Infer from file structure and suggest creating CLAUDE.md
...
- If CLAUDE.md and README.md both missing: Show inference + suggest creating docs
